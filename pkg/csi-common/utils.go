...
// ParseEndpoint parses an endpoint and splits it if the scheme is either unix:// or tcp://
...
// NewVolumeCapabilityAccessMode create a new VolumeCapability_AccessMode struct from a VolumeCapability_AccessMode_Mode int32
func NewVolumeCapabilityAccessMode(mode csi.VolumeCapability_AccessMode_Mode) *csi.VolumeCapability_AccessMode {
	return &csi.VolumeCapability_AccessMode{Mode: mode}
}

// NewDefaultNodeServer create a new default node server
...
// NewDefaultControllerServer creates a new default controller server
...
// NewControllerServiceCapability creates a new ControllerServiceCapability struct from a ControllerServiceCapability_RPC_Type int32
...
// RunNodePublishServer runs the controller and node server
...
// RunControllerPublishServer runs the controller and publish server
...
// RunControllerandNodePublishServer runs the controller and node and publish server and waits
